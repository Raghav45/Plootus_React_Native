...
class AssetsAllocationAccordion extends Component{
                            ...
                            <View key={item.key} style = {styles.subChild} >
                                ...
                                <View style={{padding:16,flexDirection:'row',justifyContent:'space-between',paddingBottom:10,paddingTop:10}} >
                                    <View >
                                        ...
                                        <Text style={{color:'gray'}}>Cost Basis: ${this.props.costBasis}</Text>
                                    </View>
                                    <View>
...
export default withNavigation(AssetsAllocationAccordion);
